...
lower_colors_augmentation_labels = "data/labels/lower_colors/lower_colors_augmentation.csv"
# check if dir exist
Path(lower_colors_augmentation_image_path).mkdir(parents=True, exist_ok=True)
allow_props = ['lowerOrange', 'lowerPurple', 'lowerGreen', 'lowerYellow', 'lowerPink', 'lowerRed', 'lowerBrown']
rotation_angles = {
    'lowerOrange': [5, 10, 15],
    'lowerPurple': [5, 10, 15],
    'lowerGreen': [5, 10, 15],
...
def join_image_path(img_name, aug_name, suffix):
    return lower_colors_augmentation_image_prefix + img_name + '_' + aug_name + '.' + suffix
