...
data_prefix = 'data/train22/'
ann_file_train = 'data/labels/lower_colors/lower_colors_train.csv'
ann_file_val = 'data/labels/lower_colors/lower_colors_val.csv'
data = dict(
    samples_per_gpu=16,
    workers_per_gpu=2,
    train=dict(
