...
from .pedestrian_eval_metrics import upper_average_performance, pedestrian_colors_average_performance
...
__all__ = [
    ...
    'upper_average_performance', 'pedestrian_colors_average_performance'
]
